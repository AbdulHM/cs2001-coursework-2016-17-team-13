...
public class RecyclerAdapter4 extends RecyclerView.Adapter<RecyclerAdapter4.RecyclerViewHolder> {
    private ArrayList<DataProvider> dataProviders = new ArrayList<DataProvider>();
    Context ctx;

    public RecyclerAdapter4 (ArrayList<DataProvider> arrayList1, Context ctx){
...
//            DataProvider dataProvider= this.dataProviders.get(musiclist.get(position));
            DataProvider dataProvider= new DataProvider(Img_res, booksList.get(position));
